...
package enum StructuredMemoryCanonicalizer {
    private static let posixLocale = Locale(identifier: "en_US_POSIX")

    package static func normalizedString(_ input: String) -> String {
    ...
    package static func normalizedAlias(_ input: String) -> String {
